      ...
      >
        ...
        {showAvatar && !isOwn && (
          <div className="flex-shrink-0 mr-3">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white text-sm font-semibold shadow-sm">
              {message.sender_type === "LANDLORD" ? "C" : "T"}
            </div>
          </div>
        )}
        ...
        <div className={`flex-1 ${isOwn ? "ml-3" : "mr-3"}`}>
          ...
          {message.reply_to_message && (
            <div className="mb-3 p-3 bg-gray-50 rounded-2xl border-l-4 border-blue-500">
              <p className="text-xs text-gray-600 mb-1 font-medium">
                Trả lời{" "}
                {message.reply_to_message.sender_type === "LANDLORD"
                  ? "Chủ trọ"
                  : "Người thuê"}
              </p>
        ...
        {showAvatar && isOwn && (
          <div className="flex-shrink-0 ml-3">
            <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl flex items-center justify-center text-white text-sm font-semibold shadow-sm">
              B
            </div>
          </div>
        )}
